...
var monkey , monkey_running,monkey3
...
function preload(){
  ...
  monkey3=loadImage("sprite_0.png")
  bananaImage = loadImage("banana.png");
  obstacleImage = loadImage("obstacle.png");
 forestImage = loadImage("ffc.jpg");
}
...
ground=createSprite(200,200,1000,1000)
  ground.addAnimation("ff",forestImage)
  ground.scale=1.5
  ground.velocityX=-8
...
//background("blue")
 ...
 FoodGroup.destroyEach(0,0) 
  ...
  //monkey.destroyeach(0,0)
    // monkey=changeAnimation("sprite_0.png",monkey3)
